...
export default function ColorPicker({ className, color, onChange }: Readonly<ColorPickerProps>): JSX.Element {
  ...
  return (
    <div className={`${className} color-picker-wrapper `} style={{ width: WIDTH }} ref={innerDivRef}>
